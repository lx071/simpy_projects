...
class sim:
    def __init__(self, dut_path, top_module_file_name, sim_folder='simulation'):
        self.input_ports_name, self.output_ports_name, ports_width = verilog_parse(dut_path, top_module_file_name)
        # print('in:', input_ports_name)
        # print('out:', output_ports_name)
        ports_name = self.input_ports_name + self.output_ports_name
